...
function displayMessage(senderId, content, chatTimeStamp) {
  ...
  if (
    ...
    // Display time if the message is from the same day
    chatDate.textContent = getChatTimestamp(chatTimeStamp);
  } else {
    // Display full date for messages from a previous day
    chatDate.textContent = getChatDate(chatTimeStamp);
  }

  message.appendChild(chatDate);
...
function getChatTimestamp(timestamp) {
  ...
  // Construct the time string in "h:mm AM/PM" format
